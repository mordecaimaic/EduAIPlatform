...
language = "zh"  # 设置为语言代码，例如 "zh"，或"cantonese" None 以自动检测
...
if processor.tokenizer.pad_token is None or processor.tokenizer.pad_token == processor.tokenizer.eos_token:
    ...
    model.resize_token_embeddings(len(processor.tokenizer))  # 设置 mean_resizing=False
